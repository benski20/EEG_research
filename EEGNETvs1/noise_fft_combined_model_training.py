...
X_combined[:, 0, :, :] += noise_ch1
X_combined[:, 2, :, :] += noise_ch3
...
model.save("eegnet_fft_finetuned_aligned_2_withoutfrozenfirstlayer_and10ofolddata_andnoalignment_withclassweight[1.25:1.25:1]_withaugmentation_noisechannel1and3.h5")

print("✅ Fine-tuning complete and model saved as eegnet_fft_finetuned_aligned.h5")
# ========== STEP 10: Evaluate model (optional) ==========
model2 = load_model("eegnet_fft_finetuned_aligned_2_withoutfrozenfirstlayer_and10ofolddata_andnoalignment_withclassweight[1.25:1.25:1]_withaugmentation_noisechannel1and3.h5")
